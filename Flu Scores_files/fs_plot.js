  ...
  (typeof exports !== "undefined" && exports !== null ? exports : window).FS_Plot = FS_Plot = (function() {
    class FS_Plot {
      constructor(canvas, teams) {
        var ew, graphics, i, j, k, l, len, len1, len2, len3, len4, m, mesh, n, options, point0, ref, ref1, ref2, ref3, ref4, ref5, style, team, y_label;
        this.teams = teams;
      ...
      render(renderTime) {
        var alpha, animationProgress, axes, b, bar, color, dataMax, dataMin, direction, h, i, interval, j, k, l, len, len1, len2, len3, len4, len5, line, lineWidth, m, n, o, overlay, p, plotBox, pts, q, r, range, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, s, stageLines, stageMain, stagePlot, str, t, target, team, teamIndex, tickLabel, tickLabels, u, value, w, weight, x, x0, x1, xBox, y, y0, y1, yBox;
        this.renderRequested = false;
        // queue next frame
        ...
        for (i = q = 0, ref9 = range / interval; (0 <= ref9 ? q <= ref9 : q >= ref9); i = 0 <= ref9 ? ++q : --q) {
      ...
      update(teamValues) {
        var animationProgress, center, i, j, k, l, left, len, len1, len2, len3, len4, m, max, min, n, o, padding, q, ref, ref1, ref2, ref3, ref4, ref5, ref6, right, sum, t, team, teamIndex, value, weekIndex, width, x, y;
        ...
        animationProgress = (getTime() - this.animationStartTime) / FS_Plot.animationDuration;
        if (this.mode === 'line') {
          for (i = m = 0, ref3 = FS_Data.epiweeks.length; (0 <= ref3 ? m < ref3 : m > ref3); i = 0 <= ref3 ? ++m : --m) {
            x = this.xTicks[i];
            ref4 = this.teams;
          ...
          for (o = 0, len4 = ref5.length; o < len4; o++) {
            [teamIndex, team] = ref5[o];
            center = (teamIndex + 0.5) / this.teams.length;
            width = 0.8 / this.teams.length;
            [left, right] = [center - width / 2, center + width / 2];
            for (weekIndex = q = 0, ref6 = FS_Data.epiweeks.length; (0 <= ref6 ? q < ref6 : q > ref6); weekIndex = 0 <= ref6 ? ++q : --q) {
